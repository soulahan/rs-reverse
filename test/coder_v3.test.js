...
test('版本3动态代码生成比对', () => {
  gv._setAttr('version', 3);
  const codePath = paths.exampleResolve('codes', '3-code.js');
  const tsPath = paths.exampleResolve('codes', '3-$_ts.json');
  const tsFullPath = paths.exampleResolve('codes', '3-$_ts-full.json');
